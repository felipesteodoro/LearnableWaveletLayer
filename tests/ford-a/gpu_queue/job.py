...
class ExperimentJob:
    ...
    mode: str                # raw | learned_wavelet | learned_wavelet_no_warmup
    config: dict = field(default_factory=dict)
    config_idx: int = 0      # index within the grid for this model+mode
    max_retries: int = 2
    ...
    @property
    def name(self) -> str:
        return f"{self.model_name}/{self.mode}/cfg{self.config_idx:03d}"
