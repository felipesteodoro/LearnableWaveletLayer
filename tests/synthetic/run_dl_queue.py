"""
Launch all DL synthetic experiments across multiple GPUs.
...
ALL_MODELS = ["CNN", "CNN_LSTM", "Transformer", "MLP"]  # LSTM excluído temporariamente
...
def main():
    parser = argparse.ArgumentParser(description="Synthetic GPU DL experiment queue")
    ...
    print(
        f"\n{'='*62}\n"
        f"  Synthetic GPU Job Queue  |  {mode_label}\n"
        f"{'='*62}\n"
