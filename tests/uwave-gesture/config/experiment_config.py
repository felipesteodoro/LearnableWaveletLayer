"""
Configurações centralizadas para os experimentos UWaveGestureLibrary
(classificação MULTIVARIADA MULTICLASSE — 3 canais de acelerômetro, 8 gestos).
...
# ============================================================================
# CONFIGURAÇÃO DO DATASET UWaveGestureLibrary
# ----------------------------------------------------------------------------
# UEA archive: 3 canais de acelerômetro (x, y, z), comprimento 315, 8 gestos.
# ~2238 amostras de treino, 2240 de teste — dataset grande o bastante para DL
# honesto (ao contrário do MotorImagery de 64 canais e poucas amostras).
# ============================================================================
UWAVE_CONFIG = {
    "dataset_name": "UWaveGestureLibrary",
    "n_classes": 8,
    "sequence_length": 315,
    "n_features": 3,                  # Multivariado: acelerômetro x/y/z
    # Os 8 gestos do dataset (numerados 1..8 no UEA → mapeados para 0..7).
    "class_labels": {
        0: "gesto_1", 1: "gesto_2", 2: "gesto_3", 3: "gesto_4",
        4: "gesto_5", 5: "gesto_6", 6: "gesto_7", 7: "gesto_8",
    },
...
LEARNED_WAVELET_CONFIG = {
    "levels": 3,
    # kernel_size=8 é adequado para seq_len=315:
    #   nível 1: 315//2 = 157 >> 8 coeficientes (suporte bem definido)
    #   nível 2: 157//2 =  78 >> 8 coeficientes
    #   nível 3:  78//2 =  39 >> 8 coeficientes (ainda OK)
    "kernel_size": 8,
...
# ----------------------------------------------------------------------------
# scoring="f1_macro": dataset multiclasse; f1 macro pondera todas as 8 classes
# igualmente, robusto a eventuais desbalanceamentos. (accuracy também é válido.)
# ============================================================================
ML_SEARCH_CONFIG = {
    "cv_splits": 5,
    "scoring": "f1_macro",
...
# ============================================================================
# MODELOS ML CLÁSSICOS (Classificação multiclasse)
# ============================================================================
ML_MODELS_CONFIG = {
    "LinearSVC": {
...
# ============================================================================
# MÉTRICAS DE AVALIAÇÃO (multiclasse)
# ============================================================================
METRICS = [
    "accuracy",
    "f1_macro",
