"""
Módulo de visualização para o experimento UWaveGestureLibrary
...
_CHANNEL_NAMES = ["accel_x", "accel_y", "accel_z"]
...
class ExperimentVisualizer:
    ...
    def plot_samples(self, X: np.ndarray, y: np.ndarray,
                     n_per_class: int = 3, title: str = "Amostras UWaveGestureLibrary",
